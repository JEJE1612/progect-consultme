...
import 'package:flutter_application_1/Feature/HomeLayOut/Presentation/Consultant/widgets/profailconsultant/rating/widget/rating_reviews.dart';
          ...
          body: SafeArea(
            child: Column(
              ...
              children: [
                ...
                isSomeWorkPressed ? const ListPostItemswork() : Ratingviews()
              ],
            ),
          ),
        );
